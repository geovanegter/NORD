  ...
  return (
    <div className="mx-auto flex w-full max-w-[640px] sm:max-w-[768px] lg:max-w-[1024px] xl:max-w-[1200px] flex-col gap-5 px-4 pb-28 pt-6 text-slate-800">
      <header className="flex items-center justify-between">
        ...
        <button
          type="button"
          className="rounded-full border border-white/70 bg-white/80 py-2 px-3 text-slate-500 shadow hover:text-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4D8BFF]/40"
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex-1 space-y-3">
              <div>
                ...
                <p className="text-sm font-semibold text-[#2563EB]">{daysElapsed}/{daysTotal} dias</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-[#F97316]">Vendas realizadas</p>
                <p className="text-sm font-semibold text-slate-900">{formatCurrency(currentValue)} / {formatCurrency(monthTarget)}</p>
              </div>
              <div>
      ...
      <section className="home-panel border border-indigo-100/60 bg-gradient-to-br from-white/85 via-white/60 to-indigo-50/30 p-6 shadow-xl shadow-indigo-900/15" style={{ '--delay': '40ms' }}>
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center">
          <div className="flex-1">
            ...
            <h1 className="mt-2 text-3xl font-bold text-slate-900">{greeting}, {capitalizedName}!</h1>
            <p className="mt-2 text-sm text-slate-500">Meta em {metaPercent}% · faltam {formatCurrency(meta.remaining)} e {meta.daysLeft} dias para fechar.</p>
